...
var choiceroll = prompt("хэдэг roll тоглох вэ?", "10");
roll = parseInt(choiceroll, 10);
 
var rp = confirm("Хожоод зогсох уу");
if (rp == true) {
	var choiceprofit= prompt("Satoshi дүн оруулна уу", "100");
	stopprofit = parseInt(choiceprofit, 10);
	}
 
var rl = confirm("Хожигдоод зогсох уу LOSS");
if (rl == true) {
	var choiceloss= prompt("", "-50");
